...
function Cart() {
  ...
  return (
    <div className="justify-self-start h-full cursor-pointer py-2 xl:py-3 relative">
      <div onClick={handleShowFilters} className={`flex items-center h-full bg-transparent hover:bg-cupcake-light ${showCart && "bg-cupcake-light"} rounded-lg transition duration-300 ease-in-out px-3`}>
